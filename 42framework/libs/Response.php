...
class Response
{
	...
	public function status($status)
	{
		switch ($status)
		{
			...
			case 407:
				return $this->setStatus('407 Proxy Authentification Required');
			...
			default:
				\trigger_error('Status \'' . $status . '\' is invalid', E_USER_ERROR);
		}
	}
	...
	public function send()
	{
		...
		{
			\trigger_error('Http header was already sent', E_USER_ERROR);
		}
		else
		{
			...
			{
				@setcookie($cookieName, $cookieProperties['value'], $cookieProperties['expire'], $cookieProperties['path'], $cookieProperties['domain'], $cookieProperties['secure']);
			}
