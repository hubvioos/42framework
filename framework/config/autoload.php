...
$autoload = array(
		 ...
		 'doctrine\\common\\classloader' => VENDORS_DIR.DS.'Doctrine'.DS.'Common'.DS.'ClassLoader.php',
         ...
         'framework\\httprequest' => FRAMEWORK_DIR.DS.'HttpRequest.php',
		 ...
		 'framework\\filterchain' => FRAMEWORK_DIR.DS.'FilterChain.php',
		 'framework\\filter' => FRAMEWORK_DIR.DS.'Filter.php',
		 'framework\\appfilterchain' => FRAMEWORK_DIR.DS.'AppFilterChain.php',
		 'framework\\appfilter' => FRAMEWORK_DIR.DS.'AppFilter.php',
		 'framework\\viewfilterchain' => FRAMEWORK_DIR.DS.'ViewFilterChain.php',
		 'framework\\viewfilter' => FRAMEWORK_DIR.DS.'ViewFilter.php',
		 ...
		 'framework\\interfaces\\ierrorhandler' => FRAMEWORK_DIR.DS.'interfaces'.DS.'iErrorHandler.php',
		 'framework\\interfaces\\ierrorhandlerlistener' => FRAMEWORK_DIR.DS.'interfaces'.DS.'iErrorHandlerListener.php',
         'framework\\libs\\loggerexception' => FRAMEWORK_DIR.DS.'libs'.DS.'Logger.php',
         'framework\\libs\\logger' => FRAMEWORK_DIR.DS.'libs'.DS.'Logger.php',
		 'framework\\applicationcontainer' => FRAMEWORK_DIR.DS.'ApplicationContainer.php',
		 'framework\\filters\\applicationfilter' => FRAMEWORK_DIR.DS.'filters'.DS.'ApplicationFilter.php',
		 'framework\\filters\\securityfilter' => FRAMEWORK_DIR.DS.'filters'.DS.'SecurityFilter.php',
		 'framework\\filters\\execfilter' => FRAMEWORK_DIR.DS.'filters'.DS.'ExecFilter.php',
		 'framework\\filters\\renderfilter' => FRAMEWORK_DIR.DS.'filters'.DS.'RenderFilter.php',
		 'framework\\frameworkobject' => FRAMEWORK_DIR.DS.'FrameworkObject.php',
		 'framework\\basecontainer' => FRAMEWORK_DIR.DS.'BaseContainer.php',
		 ...
		 'framework\\libs\\externalrequestexception' => FRAMEWORK_DIR.DS.'libs'.DS.'ExternalRequest.php',
		 'framework\\libs\\externalrequest' => FRAMEWORK_DIR.DS.'libs'.DS.'ExternalRequest.php',
         'framework\\responseexception' => FRAMEWORK_DIR.DS.'Response.php',
         'framework\\httpresponse' => FRAMEWORK_DIR.DS.'HttpResponse.php',
         'framework\\libs\\staticclassloader' => FRAMEWORK_DIR.DS.'libs'.DS.'StaticClassLoader.php',
